package ass.management.admin.test.word.policy;

import static ass.management.admin.common.word.data.NumbericRenderData.FMT_BULLET;
import static ass.management.admin.common.word.data.NumbericRenderData.FMT_DECIMAL;
import static ass.management.admin.common.word.data.NumbericRenderData.FMT_DECIMAL_PARENTHESES;
import static ass.management.admin.common.word.data.NumbericRenderData.FMT_LOWER_LETTER;
import static ass.management.admin.common.word.data.NumbericRenderData.FMT_LOWER_ROMAN;
import static ass.management.admin.common.word.data.NumbericRenderData.FMT_UPPER_LETTER;
import static ass.management.admin.common.word.data.NumbericRenderData.FMT_UPPER_ROMAN;
