    ...
    public static Object getPrivateProperty(Object bean, String name) {
        try {
            ...
            if (field != null) {
                ...
                throw new RuntimeException("The field [ " + field + "] in [" + bean.getClass().getName()
                        + "] not exists");
            }
        } catch (Exception e) {
            throw new RuntimeException(e);
    ...
    private static void createNestedBean(Object bean, String name) {
        ...
        try {
            ...
            for (int i = 0; i < names.length - 1; i++) {
                ...
                if (val == null) {
                    PropertyUtils.setProperty(bean, nestedName.toString(), PropertyUtils.getPropertyType(bean,
                            nestedName.toString()).newInstance());
                }
            }
        } catch (Exception e) {
            throw new RuntimeException(e);
