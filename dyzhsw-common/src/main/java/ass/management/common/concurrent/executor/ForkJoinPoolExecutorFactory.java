...
import ass.management.common.concurrent.pool.thread.InternalForkJoinWorkerThread;
 ...
 * @author jiachun.fjc
 */
@SpiMetadata(name = ConfigParameter.Executor.FORKJOIN)
public class ForkJoinPoolExecutorFactory extends AbstractExecutorFactory {

    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(ForkJoinPoolExecutorFactory.class);
