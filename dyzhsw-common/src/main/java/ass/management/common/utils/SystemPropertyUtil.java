...
public final class SystemPropertyUtil {
    ...
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(SystemPropertyUtil.class);
    ...
    public static String get(final String key, String def) {
        ...
        try {
            ...
            logger.error("Unable to retrieve a system property '{}'; default values will be used, {}.", key, stackTrace(e));
        }
